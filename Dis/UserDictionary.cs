...
namespace Dis
{
    public class UserDictionary
    {
        ...
        public Dictionary<string, string> add(string key, string val)
        {
            this.dic.Add(key, val);
            return dic;
        }
        public bool ClearDictinary()
        {
            this.dic.Clear();
            return true;
        }

        public Dictionary<string, string> Remove(string key)
        {
             this.dic.Remove(key);
             return this.dic;
        }

        public bool ChkFile(string filepath)
        {
        ...
        public string ChkIpIsInLocal(string ipadd)
        {
            foreach (IPAddress ip in Dns.GetHostByName(Dns.GetHostName()).AddressList)
            {
