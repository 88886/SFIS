...
namespace Input
{
    ...
    public class InputBox :System.Windows.Forms.Form
    {
        ...
        private void InputBox_Load(object sender, EventArgs e)
        {
           ...
           //         dic.Add("FUNID", this.Controls[i].Name);
           //         dic.Add("FUNNAME", this.Controls[i].Text);
           //         dic.Add("FUNDESC", this.Controls[i].Text);
           ...
           // //mst.Add("PROGID", this.Name);
           // //mst.Add("PROGNAME", this.Text);
           // //mst.Add("PROGDESC", this.Text);
           // //FrmBLL.publicfuntion.AddProgInfo(mst, lsfunls);
