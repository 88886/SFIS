   ...
   public  class CExcel
    {
        ...
        public void InsertPictures(string pictureName)
        {
            ...
            //后面的数字表示位置，位置默认
            worksheet.Shapes.AddPicture(pictureName, Office.MsoTriState.msoFalse, Office.MsoTriState.msoTrue, 10, 1, 150, 150);
        ...
        {
            Excel.Worksheet worksheet = (Excel.Worksheet)myExcel.ActiveSheet;
            worksheet.Shapes.AddPicture(pictureName, Office.MsoTriState.msoFalse, Office.MsoTriState.msoTrue, top, left, heigth, width);
        }
        ...
        public bool SaveAs(string fileName)
        {
            try
            {
                myWorkBook.SaveAs(fileName, Type.Missing, 
