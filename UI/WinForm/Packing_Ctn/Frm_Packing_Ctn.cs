...
namespace SFIS_V2
{
    ...
    {
        public Frm_Packing_Ctn( MainParent Frm )
        {
            InitializeComponent();
            mFrm = Frm;
        }
      ...
      //  string ProductLine = string.Empty;
        ...
        {
            lab_Option.Text = MyLine + " : " + MYGROUP;
         FrmBLL.CfgIniFile.IniWriteValue ("PACK_CTN", "LINE", MyLine, IniFilePath);
         FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "STATION", MYGROUP, IniFilePath);
        ...
        private void Frm_Packing_Ctn_Load(object sender, EventArgs e)
        {
           ...
           // FileVersionInfo myFileVersion = FileVersionInfo.GetVersionInfo(System.Windows.Forms.Application.ExecutablePath);
            this.Text = "PACK_CTN";//string.Format("{0} Version:{1} (Build Date:{2})", "PACK_CTN", myFileVersion.FileVersion, System.IO.File.GetLastWriteTime(System.Windows.Forms.Application.ExecutablePath).ToShortDateString());
        ...
        {
          //  MyLine = OperateIni.IniReadValue("PACK_CTN", "LINE", IniFilePath);
            MyLine = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "LINE", IniFilePath);

            MYGROUP = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "STATION", IniFilePath);
            string PatchFlag = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "PatchFlag", IniFilePath);
            string PrintProduct = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "PrintProduct", IniFilePath);
            string PrintLabel = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "PrintLabel", IniFilePath);
            My_LabelFilePatch = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "LabelFilePatch", IniFilePath);
            string OrderlyPacking = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "OrderlyPacking", IniFilePath);

            string My_Language = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "Language", IniFilePath);
            if (PatchFlag == "0")
                imbt_LabelPartnumber.Checked = true;
            else
                imbt_Labelwoid.Checked = true;
            switch (FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "PACKTYPE", IniFilePath))
            {
                case "1":
        ...
        {
            string _Port = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "myport", IniFilePath);
            string _BaudRate = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "BaudRate", IniFilePath);
            string _DataBits = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "DataBits", IniFilePath);
            string _Parity = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "Parity", IniFilePath);
            string _StopBits = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "StopBits", IniFilePath);
            string _ReadBufferSize = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "ReadBufferSize", IniFilePath);
            My_Cmd = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "cmd", IniFilePath);
        ...
        {
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "LINE", "", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PACKTYPE", "1", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "STATION", "NA", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PrintProduct", "0", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "LabelQty", "0", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "LabelX", "0.00", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "LabelY", "0.00", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "LabelFilePatch", "D:", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PrintLabel", "0", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "OrderlyPacking", "0", IniFilePath);

            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "myport", "1", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "BaudRate", "9600", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "DataBits", "8", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "Parity", "0", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "StopBits", "1", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "ReadBufferSize", "4096", IniFilePath);
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "cmd", "r", IniFilePath);
      ...
      //  }
            ...
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    if (imbt_OrderlyPacking.Checked && _Colnum=="SN")
                    {
                        ...
                        FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "SnHistory", SN, IniFilePath);
                    }
                    ...
                    if (string.IsNullOrEmpty(MyLine))
                        MyLine = dt.Rows[0]["LINE"].ToString();
        ...
        private bool FGetCartonNo()
        {
            ...
            {
                DataTable dtChkCtn = FrmBLL.publicfuntion.getNewTable(dtNoCloseCtn, string.Format("LINE='{0}' AND COMPUTER='{1}'", MyLine, FrmBLL.publicfuntion.getMacList()[0]));
        ...
        private bool GetNewCartonNo()
        {
            ...
            try
            {
                ...
                dic.Add("COMPUTER", FrmBLL.publicfuntion.getMacList()[0]);
        ...
        {
            string ErrMsg = refWebProPublicStoredproc.Instance.SP_TEST_CTN_PALT_TRAY(My_ESN, MYGROUP,mFrm.gUserInfo.userId+ "-" + mFrm.gUserInfo.pwd , "NA", MyLine, My_Carton_No, My_MCarton_No, 1);
            if (ErrMsg != "OK")
            {
        ...
        private bool CompareSnAreaHistory(string serial)
        {
            try
            {
                string history = FrmBLL.ReadIniFile.IniReadValue("PACK_CTN", "SnHistory", IniFilePath);
        ...
        private void itemSN_Click(object sender, EventArgs e)
        {
            ...
            La_GString.Text = "SN:";
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PACKTYPE", "2", IniFilePath);
        }
        private void itemIMEI_Click(object sender, EventArgs e)
        {
            Checked_ButtonItem(itemIMEI);
            La_GString.Text = "IMEI:";
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PACKTYPE", "3", IniFilePath);
       ...
       // System.Diagnostics.Stopwatch myWatch = System.Diagnostics.Stopwatch.StartNew();
        ...
        public void PrintCartonLabel_CodeSoft(string MyCartonNo)
        {
            ...
            if (dtCarton.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in FrmBLL.publicfuntion.DataTableToSort( FrmBLL.DataTableCrosstab.DataTableCross(dtKeyParts, 3), "SN").Rows)
                {
        ...
        private void imbt_PrintCtnLabel_Click(object sender, EventArgs e)
        {
            ...
            if (Check_Setting_Employee("Set_PrintLabel", out _SysUserId))
            {
                ...
                else
                {
                    ...
                    FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PrintLabel", "1", IniFilePath);
                }
            }
        }
        ...
        private void imbt_PrintProduct_Click(object sender, EventArgs e)
        {
            ...
            if (Check_Setting_Employee("Set_PrintProduct", out _SysUserId))
            {
                ...
                else
                {
                    ...
                    FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PrintProduct", "1", IniFilePath);
                }
            }
        }
        ...
        private void imbt_LabelPartnumber_Click(object sender, EventArgs e)
        {
            ...
            if (imbt_LabelPartnumber.Checked)
            {
                FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PatchFlag", "0", IniFilePath);
        ...
        private void imbt_Labelwoid_Click(object sender, EventArgs e)
        {
            ...
            {
                FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "PatchFlag", "1", IniFilePath);
        ...
        public void PublicPrintLabel(DataTable dt, string filepatch)
        {
            ...
            string PrintQty = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "LabelQty", IniFilePath);
            string coordinateX = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "LabelX", IniFilePath);
            string coordinateY = FrmBLL.CfgIniFile.IniReadValue("PACK_CTN", "LabelY", IniFilePath);
        ...
        private void imbt_English_Click(object sender, EventArgs e)
        {
            ...
            Language = 0;
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "Language", "0", IniFilePath);
        ...
        private void imbt_Chinese_Click(object sender, EventArgs e)
        {
            imbt_Chinese.Checked = true;
            Language = 1;
            FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "Language", "1", IniFilePath);
        ...
        private void imbt_OrderlyPacking_Click(object sender, EventArgs e)
        {
            ...
            if (imbt_OrderlyPacking.Checked)
                ...
                FrmBLL.CfgIniFile.IniWriteValue("PACK_CTN", "OrderlyPacking", "1", IniFilePath);
        ...
        private bool Check_Setting_Employee(string funid, out string UserId)
        {
            bool Chk_Flag = false;
            UserId = null;
            string[] EmpData = Input.InputBox.ShowInputBox("Input Employee", string.Empty);
        ...
        private void InsertSystemLog(string SysUserId, string Action_Type, string Action_Desc)
        {
            ...
            dic.Add("ACTION_DESC", Action_Desc + " ->MAC:" + FrmBLL.publicfuntion.getMacList()[0]);          
        ...
        private bool CHECK_PRODUCT_LINE()
        {
            ...
            //}
            //if (!flag)
            //    SendMsg(mLogMsgType.Error, string.Format("The WO is not available in the [{0}] line.", MyLine), string.Format("此工单不可在{0}生产", MyLine));
            //return flag;
            return true;
        }
