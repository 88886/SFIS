...
namespace Frm_iSCM.FrmPublic
{
    ...
    public class FtpClient
    {
        ...
        public void Rename(string strOldFileName, string
      ...
      strNewFileName)
        ...
        private Socket CreateDataSocket()
        {
            ...
            for (int i = 0; i < len && partCount <= 6; i++)
            {
                ...
                if (ch == ',' || i + 1 == len)
                {
                  ...
                  ("Malformed PASV strReply: " + strReply);
                    }
                }
            }
        ...
        private string ReadLine()
        {
            while (true)
            {
                int iBytes = socketControl.Receive(buffer,
